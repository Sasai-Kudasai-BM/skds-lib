...
public class BezierCurve {
	 ...
	 */
	public static final Vec3D curve1(float t, Vec3 start, Vec3 point1, Vec3 end) {
		float a = 1f - t;
		return 
			start.scale(a * a)
	 ...
	 */
	public static final Vec3D curve2(float t, Vec3 start, Vec3 point1, Vec3 point2, Vec3 end) {
		float a = 1f - t;
		return 
			start.scale(a * a * a)
	 ...
	 * (1-t)^2*P0 + 2t(1 - t)P1 + t^2*P2
	 */
	public static final Vec2D curve1(float t, Vec2 start, Vec2 point1, Vec2 end) {
		float a = 1f - t;
		return 
			start.scale(a * a)
			.add(point1.scale(2 * t * a))
	 ...
	 * (1-t)^3*P0 + 3t(1 - t)^2*P1 + 3t^2*(1 - t)*P2 + t^3*P3
	 */
	public static final Vec2D curve2(float t, Vec2 start, Vec2 point1, Vec2 point2, Vec2 end) {
		float a = 1f - t;
		return 
			start.scale(a * a * a)
			.add(point1.scale(3 *  t * a * a))
