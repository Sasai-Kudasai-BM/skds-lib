...
/**
 * Copy of jdk.internal.util.ByteArray
 */
public class NativeByteArrayOperations {

	private NativeByteArrayOperations() {
	}
	...
	private static VarHandle create(Class<?> viewArrayClass) {
		return MethodHandles.byteArrayViewVarHandle(viewArrayClass, ByteOrder.nativeOrder());
	}
}
