...
@AllArgsConstructor
public class PongPacket implements IntercomPacket<IntercomConnection<?>> {

	private final long time;

	public PongPacket(ExtendedDataInput input) throws IOException {
	...
	@Override
	public int packetId() {
		return SystemPacketRegistry.PONG_ID;
	}
