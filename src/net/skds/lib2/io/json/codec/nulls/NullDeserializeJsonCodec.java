...
public class NullDeserializeJsonCodec extends AbstractJsonCodec<Object> {

	public NullDeserializeJsonCodec(Type type, JsonCodecRegistry registry) {
		super(type, registry);
	}

	public NullDeserializeJsonCodec(JsonCodecRegistry registry) {
		super(registry);
	}
